...
setup(
    ...
    install_requires=['h5py==2.10.0', 'imageio==2.6.1', 'ipython==8.10.0', 'matplotlib==3.1.1', 'mpi4py==3.0.3', 
                      'numpy==1.17.4', 'pillow==6.2.1', 'ray==0.7.6', 'setproctitle==1.1.10', 'tensorflow==2.0.1'],
